            ...
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <div class="nav-collapse">
                        <?php if (isset($navbar)): ?>
                            <ul class="nav">
                                <li <?php echo (in_array($this->request['action'], array('admin_filterByTypeHome','admin_add_home'))) ? ' class="active"' : ''; ?>><?php echo $this->Html->link(__('Imagenes Home'), '/admin/images/filterByTypeHome'); ?></li>
                                <?php foreach ($navbar as $nav): ?>
                                    <li <?php 
                                            echo ($nav['url']['controller'] == $this->request['controller'] && $this->request['action'] != ('admin_filterByTypeHome' || 'admin_add_home')) ? ' class="active"' : ''; ?>><?php echo $this->Html->link(__($nav['title']), $nav['url']);
                                    ?></li>
                                <?php endforeach; ?>
                            </ul>
                        <?php endif; ?>
